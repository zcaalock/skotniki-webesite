...
class LOne extends React.Component {
  ...
  render() {
    return (
      ...
      <ImageMapper onMouseEnter={area => this.onEnter(area)} onMouseLeave={() => this.onLeave('Segment L: Piętro')} style={{margin: 'auto'}} imgWidth={594} width={this.props.width} src={URL} map={MAP}/>
    )
  }
}
